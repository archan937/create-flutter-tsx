 ...
 * because they are weak: a substring can pass while the surrounding generated
 * output is wrong. Assert generated snippets in full with `toResemble`, arrays
 * with `toEqual`, scalars with `toBe`, and forbidden-substring guards with a
 * regex `.test()`. This meta-test fails if any sneak back in.
 */
